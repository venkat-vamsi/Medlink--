...
class _scansState extends State<scans> {
  ...
  Future<String> _uploadImage(File imageFile) async {
    ...
    Reference reference = FirebaseStorage.instance
        .ref()
        .child('scans_images/${_user!.uid}/$fileName');
  ...
  Future<void> _saveImageToFirestore(String imageUrl) async {
    if (_user != null) {
      await _firestore.collection('scans_images').add({
        'imageUrl': imageUrl,
        'userId': _user!.uid,
  ...
  Future<void> _loadImagesFromFirestore() async {
    ...
    QuerySnapshot querySnapshot =
        await FirebaseFirestore.instance.collection('scans_images').get();
